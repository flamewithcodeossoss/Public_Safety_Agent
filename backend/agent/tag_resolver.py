...
into an exact AVEVA TagName using:
  ...
  2. Substring containment (handles partial phrases)
  3. rapidfuzz partial_ratio (handles typos, partial phrases)
  4. Token-set ratio fallback (handles word-order variations)
