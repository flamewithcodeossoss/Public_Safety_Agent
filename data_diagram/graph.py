...
Requirements:
    pip install langgraph langchain-community duckdb pandas rapidfuzz
    pip install langchain-ollama   # for Qwen via Ollama
    # OR
    pip install openai             # if using Qwen via vLLM OpenAI-compatible API
"""
...
# ════════════════════════════════════════════════════════════════════
# LLM SETUP  — swap the backend here for your serving stack
# ════════════════════════════════════════════════════════════════════
...
_FORMAT_SYSTEM = """You are a smart city monitoring assistant. 
